...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderId placeOrder(OrderForm orderForm) {
      ...
      //  newOrder.getOrderItemList().forEach(item->domainEventPublisher.publish(new OrderItemCreated(item.getDishId().getId(),item.getQuantity())));
    ...
    public void addItem(OrderId orderId, OrderItemForm orderItemForm) throws OrderIdNotExistException {
        ...
        order.addItem(orderItemForm.getDish(),orderItemForm.getQuantity());
    ...
    private Order toDomainObject(OrderForm orderForm) {
        ...
        orderForm.getItems().forEach(item->order.addItem(item.getDish(),item.getQuantity()));
        return order;
    }
}
